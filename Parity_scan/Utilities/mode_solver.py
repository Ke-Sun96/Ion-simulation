...
class TrapModel:
    ...
    def __init__(self, n_ions, com_radial, com_axial, potShape,source='model', real_units=False):
        self.n_ions = n_ions
    ...
    def define_potential(self, v_type='quadratic', q4=1, fname=''):
        self.V = TrapPotential(v_type, q4, fname)
...
class TrapPotential:
    ...
    def __init__(self, v_type='quartic', q4=1, fname=''):
        self.v_type = v_type
        self.Vtot = np.array([])
        self.Vjac = np.array([])
        self.Vhess = np.array([])
